...
<head>
    ...
    <title>GénieMémoire - Inscription</title>
    ...
    <div class="auth-card">
        ...
        <div class="login-right">
            <div class="tab-buttons">
                <a class="tab-btn" href="/Gestion_memoire/app/views/auth/connexion.php">Se connecter</a>
                <button class="tab-btn active">Créer un compte</button>
            </div>

            <h2 class="welcome-title">Créer un compte</h2>
            <p class="welcome-subtitle">Renseignez vos informations pour créer votre espace d'accès.</p>
            ...
            <div id="registerPanel">
                ...
                <form id="registerForm">
                    ...
                    <div class="signup-link">
                        Déjà inscrit ? <a href="/Gestion_memoire/app/views/auth/connexion.php">Se connecter</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        document.getElementById('registerForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = '/Gestion_memoire/app/views/auth/connexion.php';
                    }, 1800);
                } else {
