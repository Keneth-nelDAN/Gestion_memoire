...
<aside class="de-sidebar">
    ...
    <nav class="de-menu">
        ...
        <a class="<?= $active_page === 'publication' ? 'active' : '' ?>" href="publier_memoire.php">
            <i class="fa-solid fa-upload"></i> Publier un mémoire
        </a>
        <a class="<?= $active_page === 'publications' ? 'active' : '' ?>" href="publier_lots.php">
            <i class="fa-solid fa-layer-group"></i> Publier des mémoires
        </a>
        ...
        <a class="<?= $active_page === 'etudiants' ? 'active' : '' ?>" href="etudiants_de.php">
            <i class="fa-solid fa-users"></i> Ajouter etudiants
        </a>
    ...
    <a class="logout-link" href="../../../app/views/auth/confirmation_logout.php" style="background-color: #e74c3c; color: white; text-align: center; padding: 20px; border-radius: 10px ">
